...
export class PencilMapper {
  pencils: string[];
  constructor(pencilSet: string[] = DARWIN_PENCILS) { this.pencils = pencilSet; }

  mapGrayToPencil(gray: number): string {
  ...
  getAllGrades(): string[] { return [...this.pencils]; }

  getPencilColor(grade: string): PencilGrade {
